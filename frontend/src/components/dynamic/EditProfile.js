...
import { Button, Container, Box,InputLabel , Grid, TextField, Typography } from "@mui/material";
...
function createDataRows(data) {
    if (data !== undefined)
      return (
        ...
        sx={{ mt: 1 }}
      >
        {createRow("Name:",<TextField name='name' defaultValue ={data.name}></TextField>)}
        {createRow("Surname:",<TextField name='surname' defaultValue={data.surname}></TextField>)}
        {createRow("University:",<TextField name='university' defaultValue={data.university}></TextField>)}
      ...
      >
        ...
        >
          <MediaCard
            ...
            contentVar="body2"
          ></MediaCard>
          <MediaUploader parentImageList={imgUrl} setParentImageList={setImgUrl}></MediaUploader>
