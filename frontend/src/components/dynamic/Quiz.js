...
import { MobileStepper ,Snackbar} from '@mui/material';
    ...
    { this.state.booleanonsubmit ? 
        <div className="Quiz-DisplayResult"> 
           <h2> The score is {this.state.Total} Out Of 8 </h2>
             <Button onClick={()=>{this.setState({booleanonsubmit:false,activeStep:0,Quiz_Set : Quiz_Set,Total:0})}}> <AutorenewIcon/> Try again </Button> 
        </div>
     :
